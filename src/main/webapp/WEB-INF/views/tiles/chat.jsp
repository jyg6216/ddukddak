			...
			<div id="chatWindow"
				...
				<div class="chat-card">
					...
					<div id="myModal" class="modal" style="display: none;">
						...
						<div class="chat-form">
							<!-- 대화방 생성 폼 -->
							<div class="createRoomForm" id="createRoomForm" style="display: flex;">
 		        			...
 		        			if(empNoId == this.empNo){
			        			...
			        			if(this.chatCont != null) {
				        			if (result[i].atchFileDetailSavenm !== null && result[i].atchFileDetailSavenm !== '') {
					        	        ...
					        	        str += "<img src='/resources/upload/empProfile/" +result[i].atchFileDetailSavenm+"'"+" class='rounded-circle' alt=''>";
					        	        str += "</div>";
				        			}else{
			        			...
			        			str += "<div class='message-content'>" + this.chatCont + "</div></div>";
			        			str += "<div class='message-time'>" + dsp_ampm + "</div>";
			        			str += "</div>";
			        			}
...
// 			socket.onerror = onError;	//에러
		    ...
		    function sendMessage(){
		    	...
		    	//그러니까 여기에 db에 들어갈거랑 웹소켓으로 보낼 데이터들이 필요한거
		    	...
		    	var atchFileCd = '${empVO.atchFileCd}';
		    	...
		    	console.log("메세지 전송!!!!!")
		    	socket.send(empNo + "::" + chatCont + "::" + atchFileCd + "::" + chatDate);   	
				$.ajax({
		    ...
		    socket.onmessage = function(msg){
				...
				console.log("onMessage 프로필사진 :  ", atchFileCd);
				...
				if(empNo == cur_session){
        			...
        			if (atchFileCd !== null && atchFileCd !== '') {
	        			str += "<div class='d-flex'><div class='profile-picture'>";
	        	        str += "<img src='/resources/upload/empProfile/" + atchFileCd+"'"+" class='rounded-circle' alt='''>";
	        	        str += "</div>";
        			}else{
	        			str += " <div><div class='col-2'>";
	        			str += " <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-IIcYCTxyov5UIuoWBLrC2QmdBfT526Jk9g&usqp=CAU' class='rounded-circle' alt='' style='width: 40px; height: 40px;' />";
        			...
        			str += "<div class='message-content'>" + chatCont + "</div></div>";
        			str += "<div class='message-time'>" + dsp_ampm + "</div>";
        			str += "</div>";
