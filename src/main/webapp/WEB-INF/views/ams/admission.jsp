...
//   	});
     ...
     $(document).on("click", "#SaveAdmiss", function() {
  	...
  	//퇴원버튼 클릭시 필요한 전역변수
  	var clickedPaNo;	//퇴원 처리 시 선택된 환자번호
  	var clickedAdmiNo;	// 퇴원 처리 시 선택된 입원번호
...
//   		var admiFile
  	...
  	// 검색 input 요소와 자동완성 결과를 표시할 요소 가져오기
